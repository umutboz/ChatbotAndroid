...
public class ChatAdapter extends RecyclerView.Adapter<ChatAdapter.CustomViewHolder> {
    ...
    public CustomViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.list_item_chat_message, null);
    ...
    private void setAlignment(CustomViewHolder holder, boolean isMe) {
        if (!isMe) {
